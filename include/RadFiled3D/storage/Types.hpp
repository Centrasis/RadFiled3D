...
namespace RadFiled3D {
	...
	namespace Storage {
		...
		enum class RADFILED_API StoreVersion {
			V1 = 0
		};

		namespace FiledTypes {
#pragma pack(push, 4)
			struct RADFILED_API VersionHeader {
				char version[12] = { 0 };
			};
#pragma pack(pop)
			namespace V1 {
#pragma pack(push, 4)
				struct RADFILED_API VoxelGridLayerHeader {
					char name[64] = { 0 };
					char unit[32] = { 0 };
...
#pragma pack(push, 4)
				struct RADFILED_API RadiationFieldHeader {
					char field_type[64] = { 0 };
				};
#pragma pack(pop)

#pragma pack(push, 4)
				struct RADFILED_API CartesianHeader {
...
#pragma pack(push, 4)
				struct RADFILED_API PolarHeader {
					glm::uvec2 segments_counts = glm::uvec3(0);
				};
#pragma pack(pop)

#pragma pack(push, 4)
				struct RADFILED_API ChannelHeader {
					char name[64] = { 0 };
...
#pragma pack(push, 4)
				struct RADFILED_API RadiationFieldMetadataHeader {
					struct RADFILED_API Simulation {
				...
				struct RADFILED_API RadiationFieldMetadataHeaderBlock {
...
#pragma pack(pop)
		...
		class RADFILED_API RadiationFieldMetadata {
		protected:
		...
		namespace V1 {
			...
			class RADFILED_API RadiationFieldMetadata : public RadFiled3D::Storage::RadiationFieldMetadata {
